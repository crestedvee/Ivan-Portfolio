...
selectElement.addEventListener("change", (e) => {
  ...
  if (value === "light") {
      ...
      headerSec.style.backgroundImage = "url(img15.jpeg)";
      footerSection.style.backgroundImage = "url(img15.jpeg)";
      contactSection.style.backgroundImage = "url(img16.avif)";
    ...
    headerSec.style.backgroundImage = "url(img13.jpeg)";
    ...
    cForm.style.backgroundImage = "url(img13.jpeg)";
    submitBtn.style.backgroundColor = "#0892d0";
